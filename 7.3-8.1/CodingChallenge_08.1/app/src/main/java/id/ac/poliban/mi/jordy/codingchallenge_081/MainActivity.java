package id.ac.poliban.mi.jordy.codingchallenge_081;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION =
            "id.ac.poliban.mi.jordy.notifyme081.ACTION_UPDATE_NOTIFICATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("NotifyMe!_Challenge");
